...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [34] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__pair, 1, 0, 1),
  [36] = {.entry = {.count = 1, .reusable = false}}, SHIFT(18),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 1, 0, 0),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 1, 0, 0),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 0),
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 2, 0, 0),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 2),
  [48] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 2, 0, 2),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 4),
  [52] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 3, 0, 4),
  ...
  [66] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_record_repeat1, 2, 0, 3),
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_record_repeat1, 2, 0, 3), SHIFT_REPEAT(4),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escaped, 1, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [75] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_escaped_repeat1, 2, 0, 0),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_escaped_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_escaped_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 1, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_record_repeat1, 1, 0, 2),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__pair, 2, 0, 1),
